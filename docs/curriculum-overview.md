...
実務経験のあるエンジニアがAI駆動開発を許可される前に、必要な基礎知識を確認・補完するためのコースです。
...
**必須条件**:
- 全カテゴリ（01-08）で80%以上
- **セキュリティ基礎（06）は90%以上**（必須）
- プログラミング基礎（02）は85%以上（推奨）

詳細は[経験エンジニア向け AI駆動開発前提条件コース](experienced-engineer-prerequisites.md)を参照してください。
